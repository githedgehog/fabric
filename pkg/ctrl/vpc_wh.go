...
func (w *VPCWebhook) Default(_ context.Context, vpc *vpcapi.VPC) error {
	vpc.Default()

	return nil
}

func (w *VPCWebhook) ValidateCreate(ctx context.Context, vpc *vpcapi.VPC) (admission.Warnings, error) {
...
func (w *VPCWebhook) ValidateDelete(ctx context.Context, vpc *vpcapi.VPC) (admission.Warnings, error) {
