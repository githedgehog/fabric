...
// TODO(sergeymatov) verify and complete the s5248 switch profile
var profileDellS5248FON = wiringapi.SwitchProfile{
	...
	Spec: wiringapi.SwitchProfileSpec{
		...
		Ports: map[string]wiringapi.SwitchProfilePort{
			...
			"E1/49": {NOSName: "Ethernet48", Label: "49", Profile: "QSFP28-100G"},
			"E1/50": {NOSName: "Ethernet52", Label: "50", Profile: "QSFP28-100G"},
			"E1/51": {NOSName: "Ethernet56", Label: "51", Profile: "QSFP28-100G"},
			"E1/52": {NOSName: "Ethernet60", Label: "52", Profile: "QSFP28-100G"},
			"E1/53": {NOSName: "Ethernet48", Label: "53", Profile: "QSFP28-100G"},
			"E1/54": {NOSName: "Ethernet52", Label: "54", Profile: "QSFP28-100G"},
			"E1/55": {NOSName: "Ethernet56", Label: "55", Profile: "QSFP28-100G"},
			"E1/56": {NOSName: "Ethernet60", Label: "56", Profile: "QSFP28-100G"},
		},
