...
type FabricStatus struct {
	// Represents the observations of a Fabric's current state.
	// Fabric.status.conditions.type are: "Available", "Progressing", and "Degraded"
	// Fabric.status.conditions.status are one of True, False, Unknown.
	// Fabric.status.conditions.reason the value should be a CamelCase string and producers of specific
	// condition types may define expected values and meanings for this field, and whether the values
	// are considered a guaranteed API.
	// Fabric.status.conditions.Message is a human readable message indicating details about the transition.
