...
func (in *DHCPAllocatedIP) DeepCopyInto(out *DHCPAllocatedIP) {
	*out = *in
	in.Expiry.DeepCopyInto(&out.Expiry)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DHCPAllocatedIP.
func (in *DHCPAllocatedIP) DeepCopy() *DHCPAllocatedIP {
	if in == nil {
		return nil
	}
	out := new(DHCPAllocatedIP)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DHCPSubnetStatus) DeepCopyInto(out *DHCPSubnetStatus) {
	*out = *in
	if in.AllocatedIPs != nil {
		...
		*out = make(map[string]DHCPAllocatedIP, len(*in))
