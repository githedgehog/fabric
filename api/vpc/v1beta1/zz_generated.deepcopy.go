...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VPCAttachmentVIPs) DeepCopyInto(out *VPCAttachmentVIPs) {
	*out = *in
	if in.Prefixes != nil {
		in, out := &in.Prefixes, &out.Prefixes
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VPCAttachmentVIPs.
func (in *VPCAttachmentVIPs) DeepCopy() *VPCAttachmentVIPs {
	if in == nil {
		return nil
	}
	out := new(VPCAttachmentVIPs)
	in.DeepCopyInto(out)
	return out
}
