...
func (in *SwitchStateBreakout) DeepCopyInto(out *SwitchStateBreakout) {
	*out = *in
	if in.NOSMembers != nil {
		in, out := &in.NOSMembers, &out.NOSMembers
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
func (in *SwitchStateTransceiver) DeepCopyInto(out *SwitchStateTransceiver) {
	*out = *in
	if in.Rx1Power != nil {
		in, out := &in.Rx1Power, &out.Rx1Power
		*out = new(float64)
		**out = **in
	}
	if in.Rx2Power != nil {
		in, out := &in.Rx2Power, &out.Rx2Power
		*out = new(float64)
		**out = **in
	}
	if in.Rx3Power != nil {
		in, out := &in.Rx3Power, &out.Rx3Power
		*out = new(float64)
		**out = **in
	}
	if in.Rx4Power != nil {
		in, out := &in.Rx4Power, &out.Rx4Power
		*out = new(float64)
		**out = **in
	}
	if in.Rx5Power != nil {
		in, out := &in.Rx5Power, &out.Rx5Power
		*out = new(float64)
		**out = **in
	}
	if in.Rx6Power != nil {
		in, out := &in.Rx6Power, &out.Rx6Power
		*out = new(float64)
		**out = **in
	}
	if in.Rx7Power != nil {
		in, out := &in.Rx7Power, &out.Rx7Power
		*out = new(float64)
		**out = **in
	}
	if in.Rx8Power != nil {
		in, out := &in.Rx8Power, &out.Rx8Power
		*out = new(float64)
		**out = **in
	}
	if in.Tx1Bias != nil {
		in, out := &in.Tx1Bias, &out.Tx1Bias
		*out = new(float64)
		**out = **in
	}
	if in.Tx2Bias != nil {
		in, out := &in.Tx2Bias, &out.Tx2Bias
		*out = new(float64)
		**out = **in
	}
	if in.Tx3Bias != nil {
		in, out := &in.Tx3Bias, &out.Tx3Bias
		*out = new(float64)
		**out = **in
	}
	if in.Tx4Bias != nil {
		in, out := &in.Tx4Bias, &out.Tx4Bias
		*out = new(float64)
		**out = **in
	}
	if in.Tx5Bias != nil {
		in, out := &in.Tx5Bias, &out.Tx5Bias
		*out = new(float64)
		**out = **in
	}
	if in.Tx6Bias != nil {
		in, out := &in.Tx6Bias, &out.Tx6Bias
		*out = new(float64)
		**out = **in
	}
	if in.Tx7Bias != nil {
		in, out := &in.Tx7Bias, &out.Tx7Bias
		*out = new(float64)
		**out = **in
	}
	if in.Tx8Bias != nil {
		in, out := &in.Tx8Bias, &out.Tx8Bias
		*out = new(float64)
		**out = **in
	}
	if in.Tx1Power != nil {
		in, out := &in.Tx1Power, &out.Tx1Power
		*out = new(float64)
		**out = **in
	}
	if in.Tx2Power != nil {
		in, out := &in.Tx2Power, &out.Tx2Power
		*out = new(float64)
		**out = **in
	}
	if in.Tx3Power != nil {
		in, out := &in.Tx3Power, &out.Tx3Power
		*out = new(float64)
		**out = **in
	}
	if in.Tx4Power != nil {
		in, out := &in.Tx4Power, &out.Tx4Power
		*out = new(float64)
		**out = **in
	}
	if in.Tx5Power != nil {
		in, out := &in.Tx5Power, &out.Tx5Power
		*out = new(float64)
		**out = **in
	}
	if in.Tx6Power != nil {
		in, out := &in.Tx6Power, &out.Tx6Power
		*out = new(float64)
		**out = **in
	}
	if in.Tx7Power != nil {
		in, out := &in.Tx7Power, &out.Tx7Power
		*out = new(float64)
		**out = **in
	}
	if in.Tx8Power != nil {
		in, out := &in.Tx8Power, &out.Tx8Power
		*out = new(float64)
		**out = **in
	}
}
