...
func (in *AgentSpec) DeepCopyInto(out *AgentSpec) {
	*out = *in
	...
	if in.VPCAttachments != nil {
		...
		*out = make(map[string]VPCAttachmentSpecAnn, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
func (in *CatalogSpec) DeepCopyInto(out *CatalogSpec) {
	*out = *in
	...
	if in.StaticExternalSubnetOffsets != nil {
		in, out := &in.StaticExternalSubnetOffsets, &out.StaticExternalSubnetOffsets
		*out = make(map[string]uint16, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *SwitchState) DeepCopyInto(out *SwitchState) {
	*out = *in
	...
	if in.BFDPeers != nil {
		in, out := &in.BFDPeers, &out.BFDPeers
		*out = make(map[string]map[string]SwitchStateBFDPeer, len(*in))
		for key, val := range *in {
			var outVal map[string]SwitchStateBFDPeer
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
				in, out := &inVal, &outVal
				*out = make(map[string]SwitchStateBFDPeer, len(*in))
				for key, val := range *in {
					(*out)[key] = *val.DeepCopy()
				}
			}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SwitchStateBFDPeer) DeepCopyInto(out *SwitchStateBFDPeer) {
	*out = *in
	in.LastUpTime.DeepCopyInto(&out.LastUpTime)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SwitchStateBFDPeer.
func (in *SwitchStateBFDPeer) DeepCopy() *SwitchStateBFDPeer {
	if in == nil {
		return nil
	}
	out := new(SwitchStateBFDPeer)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SwitchStateInterface) DeepCopyInto(out *SwitchStateInterface) {
	*out = *in
	...
	if in.Transitions != nil {
		...
		*out = new(SwitchStateInterfaceTransitions)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SwitchStateInterfaceTransitions) DeepCopyInto(out *SwitchStateInterfaceTransitions) {
	*out = *in
	if in.Reasons != nil {
	...
	in.LastEventAt.DeepCopyInto(&out.LastEventAt)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SwitchStateInterfaceTransitions.
func (in *SwitchStateInterfaceTransitions) DeepCopy() *SwitchStateInterfaceTransitions {
	if in == nil {
		return nil
	}
	out := new(SwitchStateInterfaceTransitions)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VPCAttachmentSpecAnn) DeepCopyInto(out *VPCAttachmentSpecAnn) {
	*out = *in
	out.VPCAttachmentSpec = in.VPCAttachmentSpec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VPCAttachmentSpecAnn.
func (in *VPCAttachmentSpecAnn) DeepCopy() *VPCAttachmentSpecAnn {
	if in == nil {
		return nil
	}
	out := new(VPCAttachmentSpecAnn)
	in.DeepCopyInto(out)
	return out
}
