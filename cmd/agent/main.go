...
import (
	...
	"github.com/githedgehog/fabric/controllers"
)
...
func main() {
	...
	flag.StringVar(&hostname, "hostname", hostname, "Agent hostname that will be used to look for tasks")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "6c0331c5.githedgehog.com",
	...
	setupLog.Info("starting agent manager", "hostname", hostname, "namespace", namespace)
