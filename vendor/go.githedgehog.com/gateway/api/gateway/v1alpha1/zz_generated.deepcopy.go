...
func (in *AlloyBasicAuth) DeepCopyInto(out *AlloyBasicAuth) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlloyBasicAuth.
func (in *AlloyBasicAuth) DeepCopy() *AlloyBasicAuth {
	if in == nil {
		return nil
	}
	out := new(AlloyBasicAuth)
	in.DeepCopyInto(out)
	return out
}
